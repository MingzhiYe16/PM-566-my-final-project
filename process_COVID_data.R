...
cv_states_readin <- as.data.frame(data.table::fread("C:/Users/yemin/Desktop/PM566/week11/us-states.csv") )

# load state population data
### FINISH THE CODE HERE ###
state_pops_readin <- as.data.frame(data.table::fread("C:/Users/yemin/Desktop/PM566/week11/us_census_2018_population_estimates_states.csv"))
